...
int screen_clear(int order,int i,int change) {/*主界面的高亮控制  i表示当前高亮选项 默认为1
	...
	if (order == 1) {//主界面
		...
		i > 5 ? i = 1 : i = i;
		i==1?SetColor(11, 0): SetColor(7, 0);
		set_position(36, 6);printf("查询剧目信息");
		i == 2 ? SetColor(11, 0) : SetColor(7, 0);
		set_position(36, 8);printf("修改剧目信息");
		i == 3 ? SetColor(11, 0) : SetColor(7, 0);
		set_position(36, 10);printf("新增剧目信息");
		i == 4 ? SetColor(11, 0) : SetColor(7, 0);
		set_position(36, 12); printf("删除剧目信息");
		i == 5 ? SetColor(11, 0) : SetColor(7, 0);
		set_position(36, 14);printf("浏览所有剧目");
	}
	else if (order == 4) {
		i == 0 ? i = 4 : i = i;
		i > 4 ? i = 1 : i = i;
		i == 1 ? SetColor(11, 0) : SetColor(7, 0);
		set_position(36, 6); printf("查询影厅信息");
		i == 2 ? SetColor(11, 0) : SetColor(7, 0);
		set_position(36, 8); printf("修改影厅信息");
		i == 3 ? SetColor(11, 0) : SetColor(7, 0);
		set_position(36, 10); printf("新增影厅信息");
		i == 4 ? SetColor(11, 0) : SetColor(7, 0);
		set_position(36, 12); printf("删除影厅信息");
	}
	else {
		print_re();
	}
