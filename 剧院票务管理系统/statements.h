...
void sale_ticket(Plan *p, int judge);//售票退票
void return_ticket(Ticket *t, int judge);//退票    产生销售记录  并更新主键
void draw_ticket(Plan *p, Ticket *t);//画一张票
void draw_ticket(Ticket *t, int judge);//画一张票  0售票员   1剧院奖励
...
Record *add_record(Plan *p, Ticket *t, Account *a, sale_types type);//产生一条销售记录加到记录链表  并刷新业绩
